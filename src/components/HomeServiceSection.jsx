    ...
    <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
            ...
            {services.map((service, index) => (
                <div key={index} className="bg-[#dfe9ff] rounded-[28px] overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                {/* Top */}
                    <div className="p-7">
                    ...
                    <div className="px-3 pb-3">
                        <img src={service.image} alt={service.title} className="w-full h-[320px] object-cover rounded-[24px]" />
                    </div>
                </div>
            ))}
            </div>
